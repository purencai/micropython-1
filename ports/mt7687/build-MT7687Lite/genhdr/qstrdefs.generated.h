...
QDEF(MP_QSTR_CLKSRC_2MHz, (const byte*)"\xf1\x0b" "CLKSRC_2MHz")
QDEF(MP_QSTR_CLKSRC_32KHz, (const byte*)"\x84\x0c" "CLKSRC_32KHz")
QDEF(MP_QSTR_CLKSRC_XTAL, (const byte*)"\xdd\x0b" "CLKSRC_XTAL")
...
QDEF(MP_QSTR_global_start, (const byte*)"\x71\x0c" "global_start")
QDEF(MP_QSTR_globals, (const byte*)"\x9d\x07" "globals")
QDEF(MP_QSTR_group, (const byte*)"\xba\x05" "group")
QDEF(MP_QSTR_gstart, (const byte*)"\xa2\x06" "gstart")
QDEF(MP_QSTR_gstop, (const byte*)"\x5a\x05" "gstop")
...
QDEF(MP_QSTR_off_time, (const byte*)"\x60\x08" "off_time")
QDEF(MP_QSTR_on_time, (const byte*)"\x8e\x07" "on_time")
