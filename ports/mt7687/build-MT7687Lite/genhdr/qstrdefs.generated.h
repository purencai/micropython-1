...
QDEF(MP_QSTR_GPIO57, (const byte*)"\xf6\x06" "GPIO57")
QDEF(MP_QSTR_GPIO58, (const byte*)"\xf9\x06" "GPIO58")
QDEF(MP_QSTR_GPIO59, (const byte*)"\xf8\x06" "GPIO59")
QDEF(MP_QSTR_GPIO6, (const byte*)"\xa2\x05" "GPIO6")
QDEF(MP_QSTR_GPIO60, (const byte*)"\xd2\x06" "GPIO60")
QDEF(MP_QSTR_GPIO7, (const byte*)"\xa3\x05" "GPIO7")
QDEF(MP_QSTR_GPIO0_EINT0, (const byte*)"\x1d\x0b" "GPIO0_EINT0")
QDEF(MP_QSTR_GPIO0_GPIO, (const byte*)"\x6a\x0a" "GPIO0_GPIO")
QDEF(MP_QSTR_GPIO0_PWM0, (const byte*)"\xa1\x0a" "GPIO0_PWM0")
QDEF(MP_QSTR_GPIO0_UART1_RTS, (const byte*)"\x32\x0f" "GPIO0_UART1_RTS")
QDEF(MP_QSTR_GPIO1_EINT1, (const byte*)"\xdd\x0b" "GPIO1_EINT1")
QDEF(MP_QSTR_GPIO1_GPIO, (const byte*)"\x0b\x0a" "GPIO1_GPIO")
QDEF(MP_QSTR_GPIO1_PWM1, (const byte*)"\xc1\x0a" "GPIO1_PWM1")
QDEF(MP_QSTR_GPIO1_UART1_CTS, (const byte*)"\xe2\x0f" "GPIO1_UART1_CTS")
QDEF(MP_QSTR_GPIO24_GPIO, (const byte*)"\xdc\x0b" "GPIO24_GPIO")
QDEF(MP_QSTR_GPIO24_I2C2_SCK, (const byte*)"\xc3\x0f" "GPIO24_I2C2_SCK")
QDEF(MP_QSTR_GPIO24_PWM25, (const byte*)"\xc0\x0c" "GPIO24_PWM25")
QDEF(MP_QSTR_GPIO24_SPIM_MOSI, (const byte*)"\xcd\x10" "GPIO24_SPIM_MOSI")
QDEF(MP_QSTR_GPIO24_SPIS_MOSI, (const byte*)"\x13\x10" "GPIO24_SPIS_MOSI")
QDEF(MP_QSTR_GPIO25_GPIO, (const byte*)"\xfd\x0b" "GPIO25_GPIO")
QDEF(MP_QSTR_GPIO25_I2C2_SDA, (const byte*)"\x0f\x0f" "GPIO25_I2C2_SDA")
QDEF(MP_QSTR_GPIO25_PWM26, (const byte*)"\x42\x0c" "GPIO25_PWM26")
QDEF(MP_QSTR_GPIO25_SPIM_MISO, (const byte*)"\x8c\x10" "GPIO25_SPIM_MISO")
QDEF(MP_QSTR_GPIO25_SPIS_SCK, (const byte*)"\xb1\x0f" "GPIO25_SPIS_SCK")
QDEF(MP_QSTR_GPIO26_GPIO, (const byte*)"\x9e\x0b" "GPIO26_GPIO")
QDEF(MP_QSTR_GPIO26_I2S_TX, (const byte*)"\xb4\x0d" "GPIO26_I2S_TX")
QDEF(MP_QSTR_GPIO26_PWM27, (const byte*)"\xc0\x0c" "GPIO26_PWM27")
QDEF(MP_QSTR_GPIO26_SPIM_SCK, (const byte*)"\xcc\x0f" "GPIO26_SPIM_SCK")
QDEF(MP_QSTR_GPIO26_SPIS_CS0, (const byte*)"\xa9\x0f" "GPIO26_SPIS_CS0")
QDEF(MP_QSTR_GPIO27_GPIO, (const byte*)"\xbf\x0b" "GPIO27_GPIO")
QDEF(MP_QSTR_GPIO27_I2C1_SCK, (const byte*)"\x23\x0f" "GPIO27_I2C1_SCK")
QDEF(MP_QSTR_GPIO27_PWM28, (const byte*)"\x4e\x0c" "GPIO27_PWM28")
QDEF(MP_QSTR_GPIO28_GPIO, (const byte*)"\x50\x0b" "GPIO28_GPIO")
QDEF(MP_QSTR_GPIO28_I2C1_SDA, (const byte*)"\xe1\x0f" "GPIO28_I2C1_SDA")
QDEF(MP_QSTR_GPIO28_PWM29, (const byte*)"\xc0\x0c" "GPIO28_PWM29")
QDEF(MP_QSTR_GPIO29_GPIO, (const byte*)"\x71\x0b" "GPIO29_GPIO")
QDEF(MP_QSTR_GPIO29_I2S_MCLK, (const byte*)"\x3e\x0f" "GPIO29_I2S_MCLK")
QDEF(MP_QSTR_GPIO29_PWM30, (const byte*)"\xa9\x0c" "GPIO29_PWM30")
QDEF(MP_QSTR_GPIO29_SPIM_MOSI, (const byte*)"\x01\x10" "GPIO29_SPIM_MOSI")
QDEF(MP_QSTR_GPIO29_SPIS_MOSI, (const byte*)"\x5e\x10" "GPIO29_SPIS_MOSI")
QDEF(MP_QSTR_GPIO2_GPIO, (const byte*)"\xa8\x0a" "GPIO2_GPIO")
QDEF(MP_QSTR_GPIO2_PWM23, (const byte*)"\x32\x0b" "GPIO2_PWM23")
QDEF(MP_QSTR_GPIO2_UART1_RX, (const byte*)"\x0f\x0e" "GPIO2_UART1_RX")
QDEF(MP_QSTR_GPIO30_GPIO, (const byte*)"\x59\x0b" "GPIO30_GPIO")
QDEF(MP_QSTR_GPIO30_I2S_FS, (const byte*)"\xea\x0d" "GPIO30_I2S_FS")
QDEF(MP_QSTR_GPIO30_PWM31, (const byte*)"\x01\x0c" "GPIO30_PWM31")
QDEF(MP_QSTR_GPIO30_SPIM_MISO, (const byte*)"\xe8\x10" "GPIO30_SPIM_MISO")
QDEF(MP_QSTR_GPIO30_SPIS_MISO, (const byte*)"\x36\x10" "GPIO30_SPIS_MISO")
QDEF(MP_QSTR_GPIO31_GPIO, (const byte*)"\xb8\x0b" "GPIO31_GPIO")
QDEF(MP_QSTR_GPIO31_I2S_RX, (const byte*)"\x54\x0d" "GPIO31_I2S_RX")
QDEF(MP_QSTR_GPIO31_I2S_TX, (const byte*)"\x92\x0d" "GPIO31_I2S_TX")
QDEF(MP_QSTR_GPIO31_PWM32, (const byte*)"\xc2\x0c" "GPIO31_PWM32")
QDEF(MP_QSTR_GPIO31_SPIM_SCK, (const byte*)"\xea\x0f" "GPIO31_SPIM_SCK")
QDEF(MP_QSTR_GPIO31_SPIS_SCK, (const byte*)"\xf4\x0f" "GPIO31_SPIS_SCK")
QDEF(MP_QSTR_GPIO32_GPIO, (const byte*)"\x1b\x0b" "GPIO32_GPIO")
QDEF(MP_QSTR_GPIO32_I2S_BCLK, (const byte*)"\xbb\x0f" "GPIO32_I2S_BCLK")
QDEF(MP_QSTR_GPIO32_PWM33, (const byte*)"\x01\x0c" "GPIO32_PWM33")
QDEF(MP_QSTR_GPIO32_SPIM_CS0, (const byte*)"\xb2\x0f" "GPIO32_SPIM_CS0")
QDEF(MP_QSTR_GPIO32_SPIS_CS0, (const byte*)"\xac\x0f" "GPIO32_SPIS_CS0")
QDEF(MP_QSTR_GPIO33_GPIO, (const byte*)"\x7a\x0b" "GPIO33_GPIO")
QDEF(MP_QSTR_GPIO33_IR_TX, (const byte*)"\x03\x0c" "GPIO33_IR_TX")
QDEF(MP_QSTR_GPIO33_PWM34, (const byte*)"\xc6\x0c" "GPIO33_PWM34")
QDEF(MP_QSTR_GPIO34_GPIO, (const byte*)"\xdd\x0b" "GPIO34_GPIO")
QDEF(MP_QSTR_GPIO34_IR_RX, (const byte*)"\xc2\x0c" "GPIO34_IR_RX")
QDEF(MP_QSTR_GPIO34_PWM35, (const byte*)"\x01\x0c" "GPIO34_PWM35")
QDEF(MP_QSTR_GPIO35_EINT19, (const byte*)"\xf3\x0d" "GPIO35_EINT19")
QDEF(MP_QSTR_GPIO35_GPIO, (const byte*)"\x3c\x0b" "GPIO35_GPIO")
QDEF(MP_QSTR_GPIO35_I2S_TX, (const byte*)"\x16\x0d" "GPIO35_I2S_TX")
QDEF(MP_QSTR_GPIO35_PWM18, (const byte*)"\x0e\x0c" "GPIO35_PWM18")
QDEF(MP_QSTR_GPIO36_GPIO, (const byte*)"\x9f\x0b" "GPIO36_GPIO")
QDEF(MP_QSTR_GPIO36_PWM19, (const byte*)"\xcc\x0c" "GPIO36_PWM19")
QDEF(MP_QSTR_GPIO36_UART2_RX, (const byte*)"\x5b\x0f" "GPIO36_UART2_RX")
QDEF(MP_QSTR_GPIO37_EINT20, (const byte*)"\x5b\x0d" "GPIO37_EINT20")
QDEF(MP_QSTR_GPIO37_GPIO, (const byte*)"\xfe\x0b" "GPIO37_GPIO")
QDEF(MP_QSTR_GPIO37_PWM20, (const byte*)"\x27\x0c" "GPIO37_PWM20")
QDEF(MP_QSTR_GPIO37_UART2_TX, (const byte*)"\x3c\x0f" "GPIO37_UART2_TX")
QDEF(MP_QSTR_GPIO38_EINT21, (const byte*)"\xf5\x0d" "GPIO38_EINT21")
QDEF(MP_QSTR_GPIO38_GPIO, (const byte*)"\x51\x0b" "GPIO38_GPIO")
QDEF(MP_QSTR_GPIO38_PWM21, (const byte*)"\x29\x0c" "GPIO38_PWM21")
QDEF(MP_QSTR_GPIO38_UART2_RTS, (const byte*)"\x6a\x10" "GPIO38_UART2_RTS")
QDEF(MP_QSTR_GPIO39_EINT22, (const byte*)"\x17\x0d" "GPIO39_EINT22")
QDEF(MP_QSTR_GPIO39_GPIO, (const byte*)"\xb0\x0b" "GPIO39_GPIO")
QDEF(MP_QSTR_GPIO39_PWM22, (const byte*)"\x2b\x0c" "GPIO39_PWM22")
QDEF(MP_QSTR_GPIO39_UART2_CTS, (const byte*)"\xba\x10" "GPIO39_UART2_CTS")
QDEF(MP_QSTR_GPIO3_EINT2, (const byte*)"\x5c\x0b" "GPIO3_EINT2")
QDEF(MP_QSTR_GPIO3_GPIO, (const byte*)"\x49\x0a" "GPIO3_GPIO")
QDEF(MP_QSTR_GPIO3_PWM24, (const byte*)"\x34\x0b" "GPIO3_PWM24")
QDEF(MP_QSTR_GPIO3_UART1_TX, (const byte*)"\x68\x0e" "GPIO3_UART1_TX")
QDEF(MP_QSTR_GPIO4_EINT3, (const byte*)"\x1a\x0b" "GPIO4_EINT3")
QDEF(MP_QSTR_GPIO4_GPIO, (const byte*)"\xee\x0a" "GPIO4_GPIO")
QDEF(MP_QSTR_GPIO4_PWM2, (const byte*)"\x27\x0a" "GPIO4_PWM2")
QDEF(MP_QSTR_GPIO57_GPIO, (const byte*)"\x78\x0b" "GPIO57_GPIO")
QDEF(MP_QSTR_GPIO57_PWM36, (const byte*)"\x06\x0c" "GPIO57_PWM36")
QDEF(MP_QSTR_GPIO58_GPIO, (const byte*)"\x57\x0b" "GPIO58_GPIO")
QDEF(MP_QSTR_GPIO58_PWM37, (const byte*)"\x48\x0c" "GPIO58_PWM37")
QDEF(MP_QSTR_GPIO59_GPIO, (const byte*)"\xb6\x0b" "GPIO59_GPIO")
QDEF(MP_QSTR_GPIO59_PWM38, (const byte*)"\x06\x0c" "GPIO59_PWM38")
QDEF(MP_QSTR_GPIO5_EINT4, (const byte*)"\xdc\x0b" "GPIO5_EINT4")
QDEF(MP_QSTR_GPIO5_GPIO, (const byte*)"\x8f\x0a" "GPIO5_GPIO")
QDEF(MP_QSTR_GPIO5_PWM3, (const byte*)"\x47\x0a" "GPIO5_PWM3")
QDEF(MP_QSTR_GPIO60_GPIO, (const byte*)"\x5c\x0b" "GPIO60_GPIO")
QDEF(MP_QSTR_GPIO60_PWM39, (const byte*)"\x6d\x0c" "GPIO60_PWM39")
QDEF(MP_QSTR_GPIO6_EINT5, (const byte*)"\x9e\x0b" "GPIO6_EINT5")
QDEF(MP_QSTR_GPIO6_GPIO, (const byte*)"\x2c\x0a" "GPIO6_GPIO")
QDEF(MP_QSTR_GPIO6_PWM4, (const byte*)"\x63\x0a" "GPIO6_PWM4")
QDEF(MP_QSTR_GPIO6_SPIM_CS1, (const byte*)"\x04\x0e" "GPIO6_SPIM_CS1")
QDEF(MP_QSTR_GPIO7_EINT6, (const byte*)"\x5c\x0b" "GPIO7_EINT6")
QDEF(MP_QSTR_GPIO7_GPIO, (const byte*)"\xcd\x0a" "GPIO7_GPIO")
QDEF(MP_QSTR_GPIO7_PWM5, (const byte*)"\x83\x0a" "GPIO7_PWM5")
QDEF(MP_QSTR_GPIO7_SPIM_CS0, (const byte*)"\xe4\x0e" "GPIO7_SPIM_CS0")
QDEF(MP_QSTR_GPIO7_SPIS_MISO, (const byte*)"\x22\x0f" "GPIO7_SPIS_MISO")
...
QDEF(MP_QSTR_RX_ANY, (const byte*)"\xe6\x06" "RX_ANY")
